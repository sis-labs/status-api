...
//    server.use(contractHandler);
    ...
    createUpdate(server)
    createDelete(server)
//    server.post({path: '/contracts', contentType: 'application/json'}, createContract);
    
    // All other endpoint must validate about the existence of the contract
//    server.use(contractExists);
//    server.get('/contracts/:id', findById);
//    server.head('/contracts/:id', findById);
//    server.put({path: '/contracts/:id', contentType: 'application/json'}, updateContract);
//    server.patch({path: '/contracts/:id', contentType: 'application/json'}, updateContract);
//    server.del('/contracts/:id', deleteContract);
